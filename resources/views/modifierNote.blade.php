...
<body>
    ...
    <main>
        <h2>Modifier une note pour {{$eleve->prenom}}</h2>
        <form action="ajouterNote" method="post">
            @csrf
            <label for="matiere">Matiere</label><br/>
            <input type="text" id="matiere" name="matiere" value="{{old('matiere',$note->matiere)}}"/><br/><br/>
            <label for="note">Note</label><br/>
            <input type="number" min="0" max="10" id="note" name="note" value="{{old('note',$note->note)}}"/><br/><br/>
